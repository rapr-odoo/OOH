...
module.exports.reserve = async (req, res) => {
  let { user, email, checkIn, checkOut, suggestion } = req.body;
  ...
  try {
    ...
    var mailOptions = {
      ...
      html: `<center>Thank you ${user} for reserve home!<br /><br />Your reservation was successfully &#127881; .<br /><br /><b>Date from : ${checkIn} TO ${checkOut}</b><br /><br /> suggestion : ${suggestion}<br /><br/>&#128077; Thank you for connect us!</center>`,
    };
